...
**Demo sentence:** _“I load SC-1, press start, and watch 12 units patrol a real map with live events — then I run it again with the same seed and get the identical run.”_
...
| **P2**   | Mission planning            | waypoint tasking, A\* with terrain/threat/weather costs, feasibility gate, naive-vs-optimized | first _interactive_ feature; turns viewers into operators                  |
